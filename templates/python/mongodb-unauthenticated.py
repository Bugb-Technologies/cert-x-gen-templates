#!/usr/bin/env python3
"""
MongoDB Unauthenticated Access Detection

Detects MongoDB instances running without authentication enabled.
Tests for open admin access and ability to list databases.
