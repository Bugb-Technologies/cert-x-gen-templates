...
Deliberately NOT inert. It runs code while pip is building and it generates a
file, exactly as the flawed twin does - the ordinary work of a real build
backend. The difference is where the effects land: inside the wheel it is
producing, and nowhere else. No credential file is opened, no CI is written
into the checkout, and no socket is opened.
...
NAME = "cxg_fixture_credaccess_fixed"
VERSION = "1.0.0"
...
METADATA = (
    ...
    "Name: cxg-fixture-credaccess-fixed\n"
    "Version: %s\n"
